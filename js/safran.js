...
function InstrumentAutomation() {
	...
	var title = "<h4 style=\"color:#cc5200\">Broadsim Automated Test Suite</h4>";
	var subtitle = "<h6 style=\"color:#FFFFFF\">Automating Hardware</h6>";
	document.getElementById("details-title").innerHTML = title;
    document.getElementById("details-subtitle").innerHTML = subtitle;
    document.getElementById("details-description").innerHTML = description;
};
...
function Wavefront_Enhancement() {
	...
	var title = "<h4 style=\"color:#cc5200\">Broadsim Wavefront Enhancements</h4>";
	var subtitle = "";
	document.getElementById("details-title").innerHTML = title;
    document.getElementById("details-subtitle").innerHTML = subtitle;
    document.getElementById("details-description").innerHTML = description;
...
function Shared_LO() {
	...
	var title = "<h4 style=\"color:#cc5200\">Broadsim Wavefront Enhancements</h4>";
	var subtitle = "<h6 style=\"color:#FFFFFF\">Shared LO Architecture</h6>";
	document.getElementById("details-title").innerHTML = title;
    document.getElementById("details-subtitle").innerHTML = subtitle;
    document.getElementById("details-description").innerHTML = description;
};
...
function Environmental_Compensation() {
	...
	var title = "<h4 style=\"color:#cc5200\">Broadsim Wavefront Enhancements</h4>";
	var subtitle = "<h6 style=\"color:#FFFFFF\">Environmental Compensation</h6>";
	document.getElementById("details-title").innerHTML = title;
    document.getElementById("details-subtitle").innerHTML = subtitle;
    document.getElementById("details-description").innerHTML = description;
};
...
function Calibration_Procedures() {
	...
	var title = "<h4 style=\"color:#cc5200\">Broadsim Wavefront Enhancements</h4>";
	var subtitle = "<h6 style=\"color:#FFFFFF\">Calibration Enhancements</h6>";
	document.getElementById("details-title").innerHTML = title;
    document.getElementById("details-subtitle").innerHTML = subtitle;
    document.getElementById("details-description").innerHTML = description;
};
...
function PhaseCal() {
	var description = ""
	var title = "<h4 style=\"color:#cc5200\">Phase Calibration</h4>";
	var subtitle = "";
	document.getElementById("details-title").innerHTML = title;
    document.getElementById("details-subtitle").innerHTML = subtitle;
    document.getElementById("details-description").innerHTML = description;

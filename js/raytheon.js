...
function CSM() {
    ...
    var title = "<h4 style=\"color:#cc5200\">Synthesizer Module</h4>";
...
function LBR() {
    ...
    var title = "<h4 style=\"color:#cc5200\">L-Band Receiver</h4>";
    document.getElementById("details-title").innerHTML = title;
    document.getElementById("details-subtitle").innerHTML = "";
    document.getElementById("details-description").innerHTML = description;
}
...
function XLC() {
    ...
    var title = "<h4 style=\"color:#cc5200\">X-L Band Converter</h4>";
    document.getElementById("details-title").innerHTML = title;
    document.getElementById("details-subtitle").innerHTML = "";
    document.getElementById("details-description").innerHTML = description;
}
...
//function ADS() {
//	var description = ""
//    var title = "<h4 style=\"color:#cc5200\">Keysight ADS</h4>";
//    document.getElementById("details-title").innerHTML = title;
//    document.getElementById("details-subtitle").innerHTML = "";
//    document.getElementById("details-description").innerHTML = description;
//}
...
//function Filters() {
//	var description = ""
//    var title = "<h4 style=\"color:#cc5200\">Filter Design</h4>";
//    document.getElementById("details-title").innerHTML = title;
//    document.getElementById("details-subtitle").innerHTML = "";
//    document.getElementById("details-description").innerHTML = description;
//}

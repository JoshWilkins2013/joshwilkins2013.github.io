function Battery() {
	...
	were part of my proposal to accomplish this."
    ...
    UpdateBlock("Carestream", "Battery Life Enhancement", "", description, image);
}
...
function TestFixture() {
	...
	vital to understand existing behavior before any improvements to the system could be made."
    ...
    UpdateBlock("Carestream", "Battery Life Enhancement", "AGM Lead-Acid Battery Test Fixture", description, image);
};
...
function Cassettes() {
	...
	was to diagnose failures on the PCB\'s within these cassettes and propose possible improvements."
	UpdateBlock("Carestream", "Digital X-Ray Cassettes", "", description, "");
...
function Automation() {
	...
	consistent performance across all systems resulting in a higher-quality product."
	...
	UpdateBlock("Carestream", "Automation Framework", "", description, image);
};
...
function Communication() {
	...
	quality standards. This seamless communication ensured a more efficient and effective testing process."
	...
	UpdateBlock("Carestream", "Communication", "", description, image);
};
...
function Agile() {
	...
	UpdateBlock("Carestream", "Agile", "", description, image);
};
...
function Leadership() {
	...
	UpdateBlock("Carestream", "Leadership / Management", "", description, "");
};
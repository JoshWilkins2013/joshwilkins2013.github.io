...
function Synthesizer() {
    ...
    var title = "<h5 style=\"color:#cc5200\">High Frequency Synthesizer</h5>";
...
function AtomicClock() {
    ...
    var title = "<h5 style=\"color:#cc5200\">Atomic Clock GUI</h5>";
    if (document.getElementById("details-title").innerHTML != title) {
        document.getElementById("details-title").innerHTML = title;
        document.getElementById("details-description").innerHTML = description;
    }
...
//    var title = "<h5 style=\"color:#cc5200\">Step Response Analysis</h5>";
//    if (document.getElementById("details-title").innerHTML != title) {
//        document.getElementById("details-title").innerHTML = title;
//        document.getElementById("details-description").innerHTML = description;
//    }
...
function Presentations() {
	...
	var title = "<h5 style=\"color:#cc5200\">Quantization Error</h5>";
    if (document.getElementById("details-title").innerHTML != title) {
        document.getElementById("details-title").innerHTML = title;
        document.getElementById("details-description").innerHTML = description;
    }
...
function Embedded() {
	...
	var title = "<h5 style=\"color:#cc5200\">Real Time Embedded System</h5>";
    if (document.getElementById("details-title").innerHTML != title) {
        document.getElementById("details-title").innerHTML = title;
        document.getElementById("details-description").innerHTML = description;
    }
...
function task5() {
	...
	var title = "<h5 style=\"color:#cc5200\">Agile Database Sync Tool</h5>";
    if (document.getElementById("details-title").innerHTML != title) {
        document.getElementById("details-title").innerHTML = title;
        document.getElementById("details-description").innerHTML = description;
    }
...
function task6() {
	...
	var title = "<h5 style=\"color:#cc5200\">Output Power Level Controller</h5>";
    if (document.getElementById("details-title").innerHTML != title) {
        document.getElementById("details-title").innerHTML = title;
        document.getElementById("details-description").innerHTML = description;
    }
...
function task7() {
	...
	var title = "<h5 style=\"color:#cc5200\">Alternative Phase Noise Measurement System</h5>";
    if (document.getElementById("details-title").innerHTML != title) {
        document.getElementById("details-title").innerHTML = title;
        document.getElementById("details-description").innerHTML = description;
    }
...
function task8() {
	...
	var title = "<h5 style=\"color:#cc5200\">Temperature Dependency Testing</h5>";
    if (document.getElementById("details-title").innerHTML != title) {
        document.getElementById("details-title").innerHTML = title;
        document.getElementById("details-description").innerHTML = description;
    }
...
function task9() {
	...
	var title = "<h5 style=\"color:#cc5200\">Phase Noise Injection</h5>";
    if (document.getElementById("details-title").innerHTML != title) {
        document.getElementById("details-title").innerHTML = title;
        document.getElementById("details-description").innerHTML = description;
    }
...
function task10() {
	...
	var title = "<h5 style=\"color:#cc5200\">Misc PCBs</h5>";
    if (document.getElementById("details-title").innerHTML != title) {
        document.getElementById("details-title").innerHTML = title;
        document.getElementById("details-description").innerHTML = description;
    }
...
function task11() {
    ...
    var title = "<h5 style=\"color:#cc5200\">Noteworthy Mentions</h5>";
    if (document.getElementById("details-title").innerHTML != title) {
        document.getElementById("details-title").innerHTML = title;
        document.getElementById("details-description").innerHTML = description;
    }
...
function task12() {
	...
	var title = "<h5 style=\"color:#cc5200\">Misc Things</h5>";
    if (document.getElementById("details-title").innerHTML != title) {
        document.getElementById("details-title").innerHTML = title;
        document.getElementById("details-description").innerHTML = description;
    }
